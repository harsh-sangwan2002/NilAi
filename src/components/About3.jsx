        ...
        <div className="relative w-full h-screen">
            ...
            <div className="relative z-10 flex flex-col justify-center items-center h-full px-4 sm:px-8 text-center">
                ...
                <TypingText
                    ...
                    className="w-full max-w-3xl text-xl sm:text-2xl md:text-3xl lg:text-4xl text-red-500 leading-snug mb-6"
                    startTyping={true}
                ...
                <TypingText
                    ...
                    className="w-full max-w-3xl text-lg sm:text-xl md:text-2xl lg:text-4xl leading-snug text-red-500"
