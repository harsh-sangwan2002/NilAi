...
const features = [
    {
        ...
        description:
            "AI optimizes hospital energy and resource use to reduce waste, improve efficiency, and lower operational costs.",
        image: "/img/hospital.jpeg",
    },
    {
        title: "Sustainable Healthcare Operations",
        description:
            "Automated efficiency insights empower NHS hospitals to achieve their net-zero sustainability and environmental goals.",
        image: "/img/healthcare.jpeg",
    },
    {
        title: "Real-Time Monitoring & Reporting",
        description:
            "AI-powered dashboards offer real-time analytics on energy, water, and operational efficiencies, enabling NHS hospitals to make informed sustainability decisions.",
