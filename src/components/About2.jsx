...
const About2 = () => {
    ...
    const images = ["/images/cover3.jpg", "/images/cover4.jpg"];
    ...
    return (
        <div className="relative w-full h-screen">
            ...
            {/* Text Section */}
            <div className="relative z-10 flex flex-col items-center justify-center h-full px-4 text-center sm:px-10">
                {/* First Typing Text */}
                <TypingText
